...
export const portfolioSignals: PortfolioSignal[] = [
  {
    ...
    confidence: "MEDIUM",
    reason:
      "BTC is trading within the configured hold band relative to your average buy price.",
  },
  {
    assetId: "ethereum",
    signal: "TAKE_PROFIT",
    confidence: "HIGH",
    reason:
      "ETH is 44.6% above your average buy price. This is within the take-profit review zone.",
  },
  {
    assetId: "solana",
    signal: "BUY_ZONE",
    confidence: "MEDIUM",
    reason:
      "SOL is more than 20% below your average buy price while macro risk is not currently risk-off.",
  },
  {
    assetId: "arbitrum",
    signal: "RISK_WARNING",
    confidence: "HIGH",
    reason:
      "ARB is down more than 30% from your average buy price and sentiment remains in Fear territory.",
  },
];
...
export const alphaCandidates: AlphaCandidate[] = [
  {
    ...
    riskLevel: "MEDIUM",
    rationale:
      "Unusual volume acceleration and strong 7d momentum make this worth manual review.",
    watched: true,
  },
  {
    ...
    riskLevel: "MEDIUM",
    rationale:
      "Narrative relevance and liquidity remain constructive, with moderate volatility.",
    watched: false,
  },
  {
    ...
    riskLevel: "LOW",
    rationale:
      "Steady momentum and strong liquidity proxy place it in the watchlist candidate range.",
    watched: false,
  },
  {
    ...
    riskLevel: "HIGH",
    rationale:
      "Momentum is strong, but volatility requires a higher-risk manual review.",
    watched: false,
  },
];
...
export const watchlist: WatchlistItem[] = [
  {
    ...
    currentPrice: 12.84,
    rationale:
      "Volume acceleration and 7d momentum are above the MVP watch threshold.",
...
export const macroIndicators: MacroIndicator[] = [
  {
    ...
    trend: "FLAT",
    interpretation:
      "Rate pressure is not improving yet, but it is not accelerating.",
  },
  {
    id: "cpi-yoy",
    name: "CPI YoY",
...
export const morningBrief: MorningBrief = {
  ...
  sourceFreshness:
    "Market data refreshed 12 minutes ago. Macro data refreshed today.",
  sections: [
    {
    ...
    labels: [
      {
        ...
        explanation:
          "Clustered from repeated co-spends and long-horizon accumulation behavior. This is not a verified identity.",
      },
      {
        ...
        explanation:
          "Recent exchange-like outflows are followed by low-churn UTXO holding behavior.",
      },
    ],
    events: [
      {
        ...
        txHash:
          "f2a67c9e8d4b7a3c1e2f90184b6c5d0a2f4e7b9c8d1a3e6f9b2c4d8a0e1f7b6c",
      },
      {
        id: "btc-event-2",
        chain: "BITCOIN",
        ...
        txHash:
          "a6d3b8c2e1f94a0d7c6b5e4f3a2d1c0b9e8f7a6d5c4b3e2f1a0d9c8b7e6f5a4",
      },
    ],
    bitcoinUtxos: [
      {
        txid: "f2a67c9e8d4b7a3c1e2f90184b6c5d0a2f4e7b9c8d1a3e6f9b2c4d8a0e1f7b6c",
        vout: 0,
        valueSats: 1240000000,
        ageDays: 0,
        status: "UNSPENT",
      },
      {
        txid: "c7e2f8a9b4d1c0e6f5a3b2c9d8e7f6a5b4c3d2e1f0a9b8c7d6e5f4a3b2c1d0e9",
        vout: 2,
        valueSats: 820000000,
        ageDays: 183,
        status: "UNSPENT",
      ...
      {
        txid: "b1d4f7a0c3e6b9d2f5a8c1e4b7d0f3a6c9e2b5d8f1a4c7e0b3d6f9a2c5e8b1d4",
        vout: 1,
        valueSats: 210000000,
        ageDays: 4,
        status: "SPENT",
    ...
    labels: [
      {
        ...
        explanation:
          "Repeated high-value swaps and liquidity routing across known Solana programs.",
      },
      {
    ...
    solanaPrograms: [
      {
        ...
        interactions24h: 9,
        interpretation:
          "High routing activity suggests active repositioning rather than passive holding.",
      },
      {
        program: "Token Program",
        interactions24h: 24,
        interpretation:
          "Frequent SPL token movement across associated token accounts.",
      },
    ],
  },
];
...
export const entityClusters: EntityCluster[] = [
  {
    ...
    rationale:
      "Common-input ownership and repeated exchange-outflow consolidation suggest one high-balance cluster, but ownership is probabilistic.",
    wallets: [
      {
        address: "bc1q9f2n8x7d3m5w4v6r2s0k8l4p6a3t9c2e5z7h1m",
        chain: "BITCOIN",
      ...
      {
        address: "bc1q73k0n5v8d2m9x4p6q1r7s3t5a8c0e2h9j4l6n",
        chain: "BITCOIN",
        confidence: "LOW",
      },
    ],
  },
  {
    ...
    rationale:
      "Shared funding source and repeated routing behavior across Solana DeFi programs indicate likely operational linkage.",
    wallets: [
      {
        address: "7aVw9xZsM2pQ8rYh6Lc3Tn4Dg1Bf5Ke9Uj2Ns8PqR4Lm",
        chain: "SOLANA",
      ...
      {
        address: "3rPq8LmN6sT2uV9xY4aB7cD1eF5gH8jK0mN2pQ6rS9tU",
        chain: "SOLANA",
        confidence: "LOW",
      },
    ],
...
export const watchRules: WatchRule[] = [
  {
    ...
    condition:
      "Alert when 24h net outflow from exchange-like clusters exceeds $1M.",
    status: "ACTIVE",
  },
  {
...
export const intelligenceAlerts: IntelligenceAlert[] = [
  {
    ...
    detail:
      "Watched BTC cluster received 12.4 BTC from an exchange-like hot wallet cluster. Review accumulation context.",
    timestamp: "2026-05-29 06:42",
    target: "BTC Accumulation Cluster",
  },
  {
    ...
    detail:
      "Watched wallet routed high-value SOL swaps through Jupiter. This is observed activity, not a trade instruction.",
    timestamp: "2026-05-29 05:18",
    target: "Solana DeFi Operator",
  },
];
...
export const personalAssetsSeed: PersonalAsset[] = [
  // Crypto (49.5%)
  {
    ...
    currency: "USD",
    platform: "Binance",
    notes: "Long-term core. Target akumulasi 0.5 BTC (perlu 0.18 lagi)",
    isActive: true,
  ...
  },
  {
    ...
    currency: "USD",
    platform: "Binance",
    notes: "Target akumulasi 11 ETH (perlu 9.42 lagi)",
    isActive: true,
  ...
  },
  {
    ...
    currency: "USD",
    platform: "Stockbit",
    notes: "Concentrated 32% of US stocks — consider trim",
    isActive: true,
  ...
  // Gold
  {
    ...
    quantity: 25,
    avgBuyPrice: 1100000,
    currentPrice: 2733000,
    currency: "IDR",
    platform: "Logam Mulia",
    isActive: true,
  ...
  {
    id: "pa-rdpu-sucor-sharia",
    userId: DEMO_USER,
    name: "Sucorinvest Sharia MM",
    symbol: "SUCRSYR",
    assetType: "rpu",
    quantity: 17841856,
    avgBuyPrice: 1,
...
export const assetTransactionsSeed: AssetTransactionRecord[] = [
  ...
  },
  {
    ...
    fees: 10,
    currency: "USD",
    transactionDate: "2025-08-20T00:00:00Z",
  ...
  },
  {
    ...
    fees: 6,
    currency: "USD",
    transactionDate: "2024-10-01T00:00:00Z",
    createdAt: "2024-10-01T00:00:00Z",
  },
  {
    id: "tx-5",
...
export const cashFlowEntriesSeed: CashFlowEntry[] = [
  {
    ...
    description: "Gaji Pokok Juni 2026",
    isRecurring: true,
  ...
  },
  {
    ...
    isRecurring: true,
    recurringFrequency: "monthly",
    transactionDate: "2026-06-08T00:00:00Z",
  },
  {
    id: "cf-4",
    userId: DEMO_USER,
    ...
    currency: "IDR",
    paymentMethod: "cash",
    description: "Makan weekend",
    isRecurring: true,
    recurringFrequency: "monthly",
    transactionDate: "2026-06-09T00:00:00Z",
  },
  {
    id: "cf-5",
    userId: DEMO_USER,
  ...
  },
  {
    ...
    currency: "IDR",
    paymentMethod: "card",
    description: "Langganan AI tools",
    isRecurring: true,
    recurringFrequency: "monthly",
    transactionDate: "2026-06-01T00:00:00Z",
  },
  {
    ...
    userId: DEMO_USER,
    entryType: "expense",
    categoryId: "cat-tabungan",
    amount: 8400000,
    currency: "IDR",
    paymentMethod: "auto-debit",
    description: "DCA + Tabungan motor listrik",
    isRecurring: true,
    recurringFrequency: "monthly",
    transactionDate: "2026-06-01T00:00:00Z",
  },
  {
    ...
    userId: DEMO_USER,
    entryType: "expense",
    categoryId: "cat-renovasi",
    amount: 35000000,
    currency: "IDR",
    paymentMethod: "transfer",
    description: "Renovasi taman besar",
    isRecurring: false,
...
export const financialGoalsSeed: FinancialGoal[] = [
  {
    id: "goal-hajj",
    userId: DEMO_USER,
    name: "Haji Regular 2 Orang",
    type: "hajj",
    targetAmount: 80000000,
    currentAmount: 0,
    currency: "IDR",
    deadline: "2028-12-31T00:00:00Z",
    priority: "high",
    status: "active",
    description: "Setoran 2 x 35jt + tiket & living cost",
    icon: "kaaba",
    color: "#10b981",
  },
  {
    id: "goal-tk",
    userId: DEMO_USER,
    name: "Dana Pendidikan TK",
    type: "education",
    targetAmount: 60000000,
    currentAmount: 0,
    currency: "IDR",
    deadline: "2029-06-30T00:00:00Z",
    priority: "high",
    status: "active",
    description: "Anak masuk TK A 2029, inflation adjusted",
    icon: "book",
    color: "#3b82f6",
  },
  {
    ...
    priority: "medium",
    status: "active",
    description: "Alva N3 atau Polytron Fox 350",
    icon: "bike",
    color: "#f59e0b",
  },
  {
    ...
    currentAmount: 0,
    currency: "IDR",
    deadline: "2028-06-30T00:00:00Z",
    priority: "medium",
    status: "active",
    description: "BYD Atto 1 atau Jaecoo J5",
    icon: "car",
    color: "#ef4444",
  },
  {
    ...
    priority: "critical",
    status: "active",
    description: "3-6 bulan expense di RDPU",
    icon: "shield",
    color: "#06b6d4",
  },
];
...
export const netWorthSnapshotsSeed: NetWorthSnapshot[] = [
  ...
  },
  {
    id: "nw-2026-06",
    userId: DEMO_USER,
    snapshotDate: "2026-06-18T00:00:00Z",
    totalAssets: 857015707,
    totalLiabilities: 0,
    netWorth: 857015707,
    breakdownJson: {
      crypto: 424054094,
